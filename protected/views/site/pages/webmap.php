...
<?php echo TbHtml::pageHeader('', 'Web Map'); ?>
    ...
    'content' =>
	             ...
	             .'<th>'
						   ...
						   . TbHtml::linkbutton('01.Arusha ', array( 'url' => './uploads/arusha.php','color' =>TbHtml::BUTTON_COLOR_PRIMARY,)).'<br>'
						   . TbHtml::linkbutton('02.Dar es salaam  ', array( 'url' => './uploads/dar_es_salaam.php','color' =>TbHtml::BUTTON_COLOR_WARNING, )).'<br>'
				 ...
				 '<th>'.
						     ...
						     TbHtml::linkbutton('08.Lindi', array( 'url' => '#','color' =>TbHtml::BUTTON_COLOR_SUCCESS, )).'<br>'
						   ...
						   . TbHtml::linkbutton('13.Mtwara', array( 'url' => './uploads/mtwara.php','color' =>TbHtml::BUTTON_COLOR_SUCCESS, 'target'=>'_blank' )).'<br>'
				 ...
				 '<th>'.
						   ...
						   . TbHtml::linkbutton('16.Rukwa', array( 'url' => '#','color' =>TbHtml::BUTTON_COLOR_DANGER, )).'<br>'
